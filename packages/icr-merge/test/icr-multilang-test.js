...
// TypeScript, Go, Rust, Java, and Python by structure â€” different declarations
...
threeWay('TS â€” different functions merge', 'svc.ts',
...
threeWay('TS â€” same function edited both sides = conflict', 'svc.ts',
  `export function a() { return 1 }\n`,
...
threeWay('Go â€” different funcs merge', 'main.go',
  `func A() int { return 1 }\n`,
  `func A() int { return 1 }\nfunc B() int { return 2 }\n`,
  `func A() int { return 1 }\nfunc C() int { return 3 }\n`,
...
threeWay('Rust â€” different fns merge', 'lib.rs',
  `fn a() -> i32 { 1 }\n`,
  `fn a() -> i32 { 1 }\nfn b() -> i32 { 2 }\n`,
  `fn a() -> i32 { 1 }\nfn c() -> i32 { 3 }\n`,
...
threeWay('Java â€” different methods in same class merge', 'App.java',
  `class App {\n  int a() { return 1; }\n}\n`,
  `class App {\n  int a() { return 1; }\n  int b() { return 2; }\n}\n`,
  `class App {\n  int a() { return 1; }\n  int c() { return 3; }\n}\n`,
...
threeWay('Python â€” different defs merge', 'app.py',
  `def a():\n    return 1\n`,
  `def a():\n    return 1\n\ndef b():\n    return 2\n`,
  `def a():\n    return 1\n\ndef c():\n    return 3\n`,
...
threeWay('Python â€” same def edited both sides = conflict', 'app.py',
  `def a():\n    return 1\n`,
  `def a():\n    return 111\n`,
  `def a():\n    return 222\n`,
...
threeWay('Python â€” different methods in same class merge', 'app.py',
  `class C:\n    def a(self):\n        return 1\n`,
  `class C:\n    def a(self):\n        return 1\n    def b(self):\n        return 2\n`,
  `class C:\n    def a(self):\n        return 1\n    def c(self):\n        return 3\n`,
...
threeWay('Go â€” unparseable input -> safe fallback', 'broken.go',
